...
<f:view>
	...
	<div class="image"></div>
	<h:form>
		<h:outputLabel styleClass="static" value="Note: You can view the last 6 transactions only"></h:outputLabel>
		...
		<br>
		<h:outputLabel styleClass="static" value = "#{cardUsageMB.message}"></h:outputLabel>
		<br><br>
		<h:commandButton value="Get Transaction" action="#{cardUsageMB.populateTable}" type="submit"></h:commandButton>
		<br>
		<br>
		</h:form>
		<h:dataTable styleClass="bigTable" border="1" value = "#{cardUsageMB.transactionList}" var = "trans">
			<h:column id="column1">
				<f:facet name="header">
